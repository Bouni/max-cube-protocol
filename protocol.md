...
The temprature indicates the configurated temprature and the mode of a device. It can be decoded as following:

    hex:  |    28     |
    dual: | 0010 1000 |
            |||| ||||
            ||++-++++-- tempratur: 10 1000 -> 40 = temp * 2
            ||                     (to get the actual tempratur, the value must be divided by 2: 40/2 = 20)
            ||
            ||
            ++--------- mode: 00=auto/weekly program
                        01=manual
...
Date until indicates to which date the given temprature is set. It can be decoded as following:
...
In this example the temprature ist set til Aug 29, 2011.

### Time Until

    0000000000:                                   04

Time until indicates to which date the given temprature is set. In this example it is set to 2:00 (04 * 0,5 hours = 2:00)
